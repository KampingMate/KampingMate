...
public class HomeController {
    ...
    private static String runningProcess(List<String> doNm, List<String> faclt, List<String> lct, List<String> induty, List<String> bottom, List<String> sbrs, long userId) {
        ...
        File workingDirectory = new File("E:/Student/API");
        String cmd = "python E:/Student/API/recommend_Camp.py \"" + String.join(",", doNm) + "\" \"" + String.join(",", faclt) + "\" \"" + String.join(",", lct) + "\" \"" + String.join(",", induty) + "\" \"" + String.join(",", bottom) + "\" \"" + String.join(",", sbrs) + "\" \"" + userId + "\"";
