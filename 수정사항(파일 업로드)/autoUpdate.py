...
def fetch_data_and_save():
    try:
        ...
        file_path = os.path.join('C:/Users/Jung/eclipse-workspace/SpringBootProject/KampingMateAPI', 'GoCamping.pkl')
...
def fetch_data_and_save2():
    try:
        ...
        # 데이터프레임을 지정된 경로에 pickle 파일로 저장
        file_path = os.path.join('C:/Users/Jung/eclipse-workspace/SpringBootProject/KampingMateAPI', 'memberRate.pkl')
        df.to_pickle(file_path)
